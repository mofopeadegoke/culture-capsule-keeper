      ...
      <section id="contribute" className="py-20 bg-capsule-paper relative">
        ...
        <div className="capsule-container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2
              className="text-3xl sm:text-4xl font-serif font-semibold mb-6 animate-fade-in opacity-0"
            ...
            <p
              className="text-lg text-capsule-text/80 mb-8 animate-fade-in opacity-0"
